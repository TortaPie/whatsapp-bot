...
client.on('message', async msg => {
  ...
  if (!media || !media.data) {
    ...
    return msg.reply('❌ Mídia indisponível. Vídeos direto da camera serão suportados menores que 5s, caso queira 10s de figurinha (maximo suportado), é necessário enviar o video como documento (.mp4) menor que 10s, GIFS são aceitos normalmente.');
  }
  ...
  if (isQuickTime || isMp4) {
    ...
    if (isQuickTime && duration > 5) {
      ...
      return msg.reply(
        ...
        'Por favor, reenvie como **Documento (.mp4)** para até 10 s de duração.'
      );
    }
